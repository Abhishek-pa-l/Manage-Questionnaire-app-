		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage Questionnaire app ",
									"targetURL": "#comsapmanagequestionnaireapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapmanagequestionnaireapp-display": {
								"semanticObject": "comsapmanagequestionnaireapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.managequestionnaireapp",
									"url": sap.ui.require.toUrl("com/sap/managequestionnaireapp")
								}
							}
						}
					}
